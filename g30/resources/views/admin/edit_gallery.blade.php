                ...
                <div class="col-md-12">
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body">
                            ...
                            <form action="{{route('posteditgallery')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 imgUp form-group">
                                            <div class="imagePreview" style="background-image:url('{{ asset('public/frontend/images/gallery/'.$data->gallery_image) }}')"></div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="image_size" value="{{$data->image_size}}" class="form-control">
                                                @error('image_size')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="form-actions">
                                    <input type="hidden" name="gallery_image" value="{{$data->gallery_image}}">
