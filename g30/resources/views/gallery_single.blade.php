        ...
        <div class="container px-md-0">
            <div class="row d-flex no-gutters">
                <div class="col-lg-12 pb-5 single">
                    <div class="row">
                        <div class="img img-single w-100" style="background-image: url({{ asset('public/frontend/images/gallery/'.$data->gallery_image) }});"></div>
                        <div class="px-5 mt-4">
                            <span class="subheading">SIZE: {{$data->image_size}}</span>
