<div class="wrapper">
    <header class="top_barnav">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark flex-md-nowrap p-0 shadow">
            <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="<?php echo e(route('inplay',3)); ?>">
            ...
            <div class="collapse navbar-collapse right-profile" id="navbarsExampleDefault">
				...
				?>
                    <li class="balance-right">
                        <span>Balance: <b><?php echo e($bal); ?></b></span>
                    </li>
                    <?php if(!Session::has('loginuser')): ?>
                    <li class="nav-item">
                      <a class="nav-link" href="<?php echo e(route('login-user')); ?>">Login</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" href="<?php echo e(route('register-user')); ?>">Sign up</a>
                    </li>
                    <?php else: ?>
                    ...
                    <li class="nav-item dropdown dropdown-user-profile">
                      ...
                      <div class="dropdown-menu dropdown-menu-right"> 
                            <a class="dropdown-item" href="<?php echo e(route('listuser')); ?>"><i class="bx bx-user"></i><span>List User</span></a>
                            ...
                            <a class="dropdown-item" href="<?php echo e(route('logout-user')); ?>" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                        <i class="bx bx-power-off"></i><span><?php echo e(__('Logout')); ?></span>
                            </a>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        </nav>--><?php /**PATH /home/nationaltenders/public_html/crawling_tenders/g30/resources/views/partials/_header.blade.php ENDPATH**/ ?>