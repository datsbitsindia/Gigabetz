                            ...
                            <div class="nav-tabs-navigation">
                                <div class="nav-tabs-wrapper">
                                    <ul class="nav nav-tabs" data-tabs="tabs">
                                        <li class="nav-item">
                                            <a class="nav-link <?php if($id == 3){ echo "active"; } ?>" href="<?php echo e(route('inplay',3)); ?>">
                                                <i class="fa fa-cricket"></i>
                                                Cricket
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link <?php if($id == 1){ echo "active"; } ?>" href="<?php echo e(route('inplay',1)); ?>">
                                                <i class="material-icons"></i>
                                                Soccer
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link <?php if($id == 13){ echo "active"; } ?>" href="<?php echo e(route('inplay',13)); ?>">
                                                <i class="material-icons"></i>
                                                Tennis
                                            </a>
                                          ...
                                          <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle">
                                                    <a href="<?php echo e(route('details',$rid)); ?>">
                                                ...
                                                <td class="align-middle">
                                                <span class="popup" datasport="<?php echo e($id); ?>" datafid="<?php echo e($val['id']); ?>" databetid="<?php echo e($betid1); ?>" dataodval="<?php echo e($value1); ?>" dataodcalval="<?php echo e(calculate($value1)); ?>" dataeventname="<?php echo e($eventname); ?>" mgvalue="<?php echo e($mgvalue); ?>">
                                                <?php 
                                                //echo $value1." ";
                                                ...
                                                <td class="align-middle">
                                                 <span class="popup" datasport="<?php echo e($id); ?>" datafid="<?php echo e($val['id']); ?>" databetid="<?php echo e($betid2); ?>" dataodval="<?php echo e($value2); ?>" dataodcalval="<?php echo e(calculate($value2)); ?>" dataeventname="<?php echo e($eventname); ?>"  mgvalue="<?php echo e($mgvalue); ?>">
                                                ...
                                                <td class="align-middle">
                                                <span class="popup" datasport="<?php echo e($id); ?>" datafid="<?php echo e($val['id']); ?>" databetid="<?php echo e($betid3); ?>" dataodval="<?php echo e($value3); ?>" dataodcalval="<?php echo e(calculate($value3)); ?>" dataeventname="<?php echo e($eventname); ?>"  mgvalue="<?php echo e($mgvalue); ?>">
...
$("body").on('click','.submit_bitpopup',function(e)
{
    ...
    if(betamt != ""){
      $.ajax({
        'type': 'POST',
        url: <?php echo json_encode(url('submitbitpopup')); ?>,
        dataType: "json",
        'data': {"_token": "<?php echo e(csrf_token()); ?>",SportID: datasport,FIID: datafid,BetID: databetid,BetAmount: betamt,ODValue: dataodval,ODCalcValue: dataodcalval,EventName: dataeventname,MarketGroup: mgvalue},
        'cache': false,
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nationaltenders/public_html/crawling_tenders/g30/resources/views/inplay.blade.php ENDPATH**/ ?>