...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row mb-0 mt-4">
                            <div class="col-md-8 offset-md-4">
                                <p><a href="<?php echo e(route('register')); ?>">Click Here to register</a></p>
                            </div>
                        </div>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u215456295/domains/jayanandkarak.in/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>