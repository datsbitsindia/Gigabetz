<div class="wrapper">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown dropdown-user-profile">
                      ...
                      <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item" href="javaScript:;"><i
                          ...
                          <a class="dropdown-item" href="<?php echo e(route('logout-user')); ?>"
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        </nav><?php /**PATH C:\xampp\htdocs\vijil\g30\resources\views/partials/_header.blade.php ENDPATH**/ ?>