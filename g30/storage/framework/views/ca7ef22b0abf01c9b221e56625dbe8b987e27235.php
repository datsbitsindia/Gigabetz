...
unset($__errorArgs, $__bag); ?>
						...
						<div class="form-group row">
                            <label for="RoleID" class="col-md-4 col-form-label text-md-right"><?php echo e(__('RoleID')); ?></label>

                            <div class="col-md-6">
   
								<select id="RoleID" type="text" class="form-control <?php $__errorArgs = ['RoleID'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="RoleID" value="<?php echo e(old('RoleID')); ?>" >
                                        <option value="">Select Account Type</option>
										<option value="0">Super Master</option>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="form-group row">
                            <label for="ExposureLimit" class="col-md-4 col-form-label text-md-right"><?php echo e(__('ExposureLimit')); ?></label>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="form-group row">
                            <label for="CreditReference" class="col-md-4 col-form-label text-md-right"><?php echo e(__('CreditReference')); ?></label>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="form-group row">
                            <label for="CommissionSetting" class="col-md-4 col-form-label text-md-right"><?php echo e(__('CommissionSetting')); ?></label>

                            <div class="col-md-6">
                                <input id="CommissionSetting" type="text" class="form-control <?php $__errorArgs = ['CommissionSetting'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="CommissionSetting" value="<?php echo e(old('CommissionSetting')); ?>" required autocomplete="CommissionSetting" >

                                <?php $__errorArgs = ['CommissionSetting'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="form-group row">
                            <label for="PartnershipSetting" class="col-md-4 col-form-label text-md-right"><?php echo e(__('PartnershipSetting')); ?></label>

                            <div class="col-md-6">
                                <input id="PartnershipSetting" type="text" class="form-control <?php $__errorArgs = ['PartnershipSetting'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="PartnershipSetting" value="<?php echo e(old('PartnershipSetting')); ?>" required autocomplete="PartnershipSetting" >

                                <?php $__errorArgs = ['PartnershipSetting'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="form-group row">
                            <label for="BetLimitSetting" class="col-md-4 col-form-label text-md-right"><?php echo e(__('BetLimitSetting')); ?></label>

                            <div class="col-md-6">
                                <input id="BetLimitSetting" type="text" class="form-control <?php $__errorArgs = ['BetLimitSetting'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="BetLimitSetting" value="<?php echo e(old('BetLimitSetting')); ?>" required autocomplete="BetLimitSetting" >

                                <?php $__errorArgs = ['BetLimitSetting'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="form-group row">
                            <label for="MinimumOdds" class="col-md-4 col-form-label text-md-right"><?php echo e(__('MinimumOdds')); ?></label>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="form-group row">
                            <label for="MaximumOdds" class="col-md-4 col-form-label text-md-right"><?php echo e(__('MaximumOdds')); ?></label>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vijil\g30\resources\views/addusers.blade.php ENDPATH**/ ?>