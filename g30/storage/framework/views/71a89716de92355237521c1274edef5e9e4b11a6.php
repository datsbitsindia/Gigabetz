...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input type="text" class="formStyle" name="mumuksh" placeholder="" value="<?php echo e(old('mumuksh')); ?>">
                    </div>
                    <div class="col-md-12 form-group">
                      <label for="InputName">क्या आप छ'रि पालक संघ का पूरा पुण्य कमाने हेतु चंपल जूते व दाढ़ी सेविंग का त्याग करना चाहते है ?</label>
                      <input type="text" class="formStyle" name="punya_kamane_hetu" placeholder="" value="<?php echo e(old('punya_kamane_hetu')); ?>">
                    </div>
                    <div class="col-md-12 form-group">
            ...
            <div class="row">
              <div class="col-md-12">
                <p class="useful-things">संघ के नियम व सूचनाएं पीछे लिखे हुए है, हमने पढ़ लिए है। हम नियमो का पालन व सूचनाए का स्वीकार करते है।</p>
              </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <p class="text-center text-danger"><strong>सूचना : आवेदन पत्र  १-१०-२०२० दिनांक तक उपलब्ध होगा</strong></p>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tenderkings/public_html/crm/timir/resources/views/adduser.blade.php ENDPATH**/ ?>