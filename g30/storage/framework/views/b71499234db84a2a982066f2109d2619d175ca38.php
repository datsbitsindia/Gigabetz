...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <?php if(auth()->guard('admin')->user()->id != 6){ ?>
            ...
            <?php } ?>
            <li class="nav-item start ">
                <a href="<?php echo e(route('tempmemberlisting')); ?>" class="nav-link ">
                    <i class="icon-user"></i>
                    <span class="title">Download Documents memberlisting</span>
                </a>
            </li>
    ...
    <!-- END SIDEBAR -->
</div><?php /**PATH /home/u215456295/domains/jayanandkarak.in/public_html/resources/views/admin/partials/_header.blade.php ENDPATH**/ ?>